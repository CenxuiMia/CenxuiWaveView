...
public class WaveView extends LinearLayout {
    ...
    public final void setWaveHz(int Hz) {
        mWaveHz = Hz;
    }

    public final void setWaveHeight(int Height) {
        mWaveHeight = Height;
    }

    public final int getWaveToTop() {
        return mWaveToTop ;
    }

    public final void setLiquidColor(int color) {
        setLiquidColor(color,Wave.DEFAULT_ABOVE_WAVE_ALPHA,Wave.DEFAULT_BLOW_WAVE_ALPHA);
    }

    public final void setLiquidColor(int color ,int AlphaAbove ,int AlphaBlow) {

        mWave.getAboveWavePaint().setColor(color);
        mWave.getAboveWavePaint().setAlpha(AlphaAbove);
        mWave.getAboveWavePaint().setStyle(Paint.Style.FILL);
        mWave.getAboveWavePaint().setAntiAlias(true);
        mSolid.setAboveWavePaint(mWave.getAboveWavePaint());

        mWave.getBlowWavePaint().setColor(color);
        mWave.getBlowWavePaint().setAlpha(AlphaBlow);
        mWave.getBlowWavePaint().setStyle(Paint.Style.FILL);
        mWave.getBlowWavePaint().setAntiAlias(true);
        mSolid.setBlowWavePaint(mWave.getBlowWavePaint());
    }
